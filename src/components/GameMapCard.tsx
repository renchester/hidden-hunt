...
function GameMapCard(props: GameMapCardProps) {
  ...
  return (
    <article aria-labelledby="map-title" className="relative group font-inter">
      ...
      <div
        className="absolute top-0 bottom-0 w-1/3 flex flex-col justify-end px-10 pb-10 group-hover:bg-amber-400 group-focus-within:bg-amber-400 group-hover:text-black
       group-focus-within:text-black  text-white"
      >
        <div className="bg-rose-600 p-5 rounded-md group-hover:bg-transparent group-focus-within:bg-transparent">
          ...
          <div className="text-sm  bg-yellow-400 text-black w-fit px-2 py-1 rounded-md  font-semibold mb-10 group-hover:bg-orange-700 group-hover:text-white">
            {map.difficulty}
          </div>
